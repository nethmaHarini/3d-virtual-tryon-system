...
export default function GarmentDetail() {
  ...
  const styles = {
    ...
    mediaPanel: {
      ...
      boxSizing: "border-box",
      minHeight: 520,
      boxShadow: isDark ? "inset 0 1px 0 rgba(255,255,255,0.04)" : "inset 0 1px 0 rgba(15,23,42,0.02)",
    },
    previewFrame: {
      width: "100%",
      maxWidth: 420,
      height: 470,
      borderRadius: 18,
      background: isDark ? "rgba(10, 15, 24, 0.9)" : "rgba(226, 232, 240, 0.9)",
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
      boxShadow: isDark
            ...
            <div style={styles.infoPanel}>
                ...
                {sizes.map((size) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...styles.sizeButton,
                        background: selected ? "linear-gradient(135deg, #7C3AED 0%, #8B5CF6 100%)" : colors.sizeBg,
                        color: selected ? "#ffffff" : colors.sizeText,
                        border: selected ? "1px solid rgba(124, 58, 237, 0.65)" : colors.sizeBorder,
                        boxShadow: selected
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: selectedSize ? "0 12px 24px rgba(124, 58, 237, 0.22)" : "none",
                  opacity: selectedSize ? 1 : 0.8,
                }}
